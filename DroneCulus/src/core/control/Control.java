...
/**
 * This Class grants Access to the PrintStream for displaying Information
 * relevant for Flight, because the YaDrone CommandManager makes it impossible
 * to read the Console. It also grants Access to the DataStorage and the Drone.
 * Furthermore it starts the ControlView.
 * 
 */
public class Control {
	...
	// TODO: DataCenter is secured as a Singleton and could be accessed static
	// from every Class,
	// but drone and PrintStream are just final, that's why everything is listed
	// here.
	...
	public final static Controller leapController =new Controller();
	...
	public static void start() {
		...
		OculusRiftEventManager
				.setTriggerIntervall(Config.MILLIS_FOR_EVENTMANAGER);

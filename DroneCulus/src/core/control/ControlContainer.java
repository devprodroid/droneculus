...
public class ControlContainer extends JPanel{
	...
	private void initImage() {
		...
		image = new ImageIcon(getClass().getResource("/resources/Xbox-Rift-Template01.png"));
		Border b1 = new BevelBorder(BevelBorder.LOWERED, Color.LIGHT_GRAY, Color.LIGHT_GRAY);
		...
		comboBox.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				switch(selected) {
					...
					case "Version1": 		image = new ImageIcon(getClass().getResource("/resources/Xbox-Rift-Template01.png"));
											break;
										
					case "Version2": 		image = new ImageIcon(getClass().getResource("/resources/Xbox-Rift-Template02.png"));
											break;
	 ...
	 * @param text = new String of InitLabel

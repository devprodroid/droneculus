...
/**
 * Startpoint for everything Manages Controller and OculusRiftManager
 *
 */
public class ControlManager {
	 ...
	 * @throws Exception
	 *             = NullPointerException, if a Device could not be found
	 */
	 ...
	 *            = Version to start with
	 * @throws Exception
	 *             = NullPointerException, if OculusRift Device could not be
	 *             found
	 */
	 ...
	 *            = Version to start with
	 * @throws Exception
	 *             = NullPointerException, if Controller Device could not be
	 *             found
	 */
	...
	/**
	 * Inner Classes for individual handling of the Events from the ControlView
	 * Components
	 *
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (Control.isDroneConnected) {
				...
				try {
					...
					case "Version1":
						startWithConfig(Template.Version1);
						break;

					case "Version2":
						startWithConfig(Template.Version2);
						break;
	...
	class LogBoxListener implements ActionListener {
		...
		@Override
		public void actionPerformed(ActionEvent e) {
			flightOut.setVisible(controlView.isLogBoxChecked());
		}
